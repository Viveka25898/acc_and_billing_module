// Components/RelieverPaymentPreviewModal.jsx
import React from 'react'
import PaymentActions from './PaymentActions'

const RelieverPaymentPreviewModal = ({ data, onClose, onRequestChanges, onAccept }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 z-50 flex items-center justify-center px-2">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold">Preview Reliever Payment Details</h2>
