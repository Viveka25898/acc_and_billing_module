...
export default function AVPRelieverApprovalPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-green-700 to-green-600 px-6 py-5 text-white shadow-sm">
        <h1 className="text-xl font-bold tracking-wide">AVP Operations - Reliever Approvals</h1>
        <p className="text-green-100 text-sm mt-0.5">Review and approve or reject reliever payment claims for operations</p>
      </div>
      ...
      <div className="p-6">
        ...
        {loading ? (
          ...
          <LineManagerApprovalTable
            ...
            showActions={true}
            activeStatus="Pending AVP Operations Approval"
          />
        )}
      </div>
    </div>
