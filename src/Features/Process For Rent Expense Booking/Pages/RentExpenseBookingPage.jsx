      ...
      <div className="p-4 mb-10 overflow-x-auto">
        {sites.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-500">No sites found. Add your first site to get started.</p>
            <button
              onClick={() => setShowAddSiteModal(true)}
                  ...
                  return (
                    <tr key={site.siteId} className="text-center hover:bg-gray-50">
                      ...
                      <td className="border px-2 py-1">
                        {agreement?.withGST ? "Yes" : site.rentConfig?.gstExpected === "yes" ? "Yes" : "No"}
                      </td>
                      <td className="border px-2 py-1">
                        {agreement ? (
                ...
                {[...Array(totalPages)].map((_, i) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded border ${
                      currentPage === i + 1 ? "bg-green-600 text-white" : "bg-white text-gray-800 hover:bg-gray-100"
                    }`}
                  >
                    {i + 1}
                  </button>
