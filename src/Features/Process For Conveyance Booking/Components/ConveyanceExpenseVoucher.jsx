...
const ConveyanceExpenseVoucher = ({ data = {}, onClose }) => {
  ...
  const header = data.header || {
    ...
    approvalChain: data.approvalChain || "Manager → VP → Billing Executive"
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 sm:p-4 z-50">
      <div className="w-full max-w-5xl bg-white rounded-lg shadow-xl overflow-hidden max-h-[90vh] overflow-y-auto">
        {/* Modal Header */}
        <div className="sticky top-0 bg-teal-600 text-white p-3 sm:p-4 flex justify-between items-center">
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="border-t pt-3 sm:pt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div className="text-center">
                <div className="border-b border-gray-300 pb-1 sm:pb-2 mb-1 sm:mb-2 h-8 sm:h-10"></div>
                <p className="text-xs sm:text-sm font-medium text-gray-700">Finance Manager</p>
                <p className="text-2xs sm:text-xs text-gray-500">{approvals.reviewer}</p>
                <p className="text-2xs sm:text-xs text-gray-400">{approvals.date}</p>
              </div>
              <div className="text-center">
                <div className="border-b border-gray-300 pb-1 sm:pb-2 mb-1 sm:mb-2 h-8 sm:h-10"></div>
                <p className="text-xs sm:text-sm font-medium text-gray-700">VP Operations</p>
                <p className="text-2xs sm:text-xs text-gray-500">{approvals.approver}</p>
                <p className="text-2xs sm:text-xs text-gray-400">{approvals.date}</p>
              </div>
            </div>
          </div>
