...
export default function VPConveyanceFormPage() {
  ...
  return (
    <div className="p-4 max-w-6xl mx-auto bg-white rounded-md shadow-md">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold text-green-600">Conveyance Booking Form - (VP)</h2>
        <button
          className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 cursor-pointer"
          onClick={() => navigate("/dashboard/vp-operations/my-conveyance-requests")}
        >
