...
export default function AMManualPurchaseEntryModal({ invoice, onClose, onSubmit }) {
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="bg-white w-full max-w-xl rounded-lg shadow-lg p-6 relative overflow-y-auto max-h-[90vh]">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Manual Purchase Entry (Account Manager)</h2>
