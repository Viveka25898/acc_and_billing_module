// src/pages/AM/AMFixedAssetEntryPage.jsx
import React, { useState, useEffect } from "react";
import { useParams, useLocation, useNavigate } from "react-router-dom";
import { toast } from "react-toastify";

const AMFixedAssetEntryPage = () => {
  ...
  useEffect(() => {
    if (location.state && location.state.invoice) {
      ...
      navigate("/dashboard/account-manager/invoice-review");
    }
  }, [location, navigate]);
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Fixed Asset Entry Submitted by Account Manager:", { ...assetEntry, invoiceId });
    toast.success("✅ Fixed Asset Purchase Entry Completed by Account Manager");
    navigate("/dashboard/account-manager/invoice-review");
  };
  ...
  return (
    <div className="max-w-3xl mx-auto p-4 md:p-6 bg-white rounded-xl shadow">
      <h2 className="text-xl md:text-2xl font-bold text-blue-700 mb-6">
        Fixed Asset Entry (Account Manager)
      </h2>
...
export default AMFixedAssetEntryPage;