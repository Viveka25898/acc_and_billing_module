...
const YearSelectionModal = ({ isOpen, onClose, onSelect }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('YearSelectionModal: handleSubmit error', err)
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-800">Select Year</h2>
              <p className="text-sm text-gray-500">Choose year for P&L Report</p>
            </div>
          </div>
          <button
            onClick={handleClose}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Financial year starts from April to March
              </p>
            </div>
