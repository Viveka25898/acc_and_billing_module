// Round Off Ledger Header Component
import React from 'react'

const RoundOffLedgerHeader = ({ ledgerInfo }) => {
  if (!ledgerInfo) return <div>Loading ledger details...</div>

  return (
    <div className="bg-gradient-to-r from-gray-500 to-gray-600 text-white p-6 sm:p-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
          <div className="text-2xl sm:text-3xl font-bold mb-2">ROUND OFF LEDGER</div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="flex flex-col">
          <div className="text-xs opacity-90 mb-1">Purpose</div>
          <div className="text-base font-semibold">Invoice Rounding</div>
        </div>
      </div>
...
export default RoundOffLedgerHeader
