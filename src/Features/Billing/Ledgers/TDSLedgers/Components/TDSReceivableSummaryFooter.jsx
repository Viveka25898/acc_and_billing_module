// TDS Receivable Summary Footer Component
import React from 'react'
import { TrendingUp, TrendingDown, DollarSign, FileText } from 'lucide-react'

const TDSReceivableSummaryFooter = ({ summary, ledgerDetails }) => {
    ...
    <div className="border-t bg-gradient-to-r from-slate-50 to-gray-50 p-6">
      ...
      <div className="mt-4 bg-cyan-50 border border-cyan-200 rounded-lg p-4">
        <div className="text-sm text-cyan-800">
          <strong>Note:</strong> TDS u/s 194J @ 10% on professional services. Claimable as advance
          tax credit in ITR filing.
        </div>
      </div>
    </div>
  )
...
export default TDSReceivableSummaryFooter
