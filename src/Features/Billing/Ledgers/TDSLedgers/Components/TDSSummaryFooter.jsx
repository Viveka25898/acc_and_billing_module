// TDS Summary Footer Component
import React from 'react'
import { TrendingUp, TrendingDown, DollarSign, FileText } from 'lucide-react'

const TDSSummaryFooter = ({ summary, ledgerDetails }) => {
    ...
    <div className="border-t bg-gradient-to-r from-slate-50 to-gray-50 p-6">
      ...
      <div className="mt-4 bg-teal-50 border border-teal-200 rounded-lg p-4">
        <div className="text-sm text-teal-800">
          <strong>Note:</strong> TDS u/s 194C @ 2% on contracts. Payment due by 7th of following
          month via Challan 281.
        </div>
      </div>
    </div>
  )
...
export default TDSSummaryFooter
