        ...
        try {
            ...
            const consolidatedTxns = relevantTxns.map(txn => {
                ...
                return {
                    ...
                    debit: totalDebit,
                    credit: totalCredit,
                    costCenter: clientEntries[0].costCenter || txn.costCenter || 'HEAD OFFICE',
                    customer: txn.customer || txn.clientName || client.clientName || '-',
                    site: clientEntries[0].site || txn.site || '-',
                    state: txn.state || '-',
                    city: txn.city || '-',
                    branch: txn.branch || '-',
