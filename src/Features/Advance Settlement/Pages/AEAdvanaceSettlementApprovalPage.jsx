...
import JVDisplay from '../Components/JVDisplay'; // Add this line to import JV component
...
const AEAdvanceSettlementApproalPage = () => {
  ...
  const rowsPerPage = 2;
  const [showJVFor, setShowJVFor] = useState(null); // New state for JV rendering
  ...
  const handleApprove = (id) => {
    ...
    setShowJVFor(approvedRequest); // Show JV after approval
  };
 ...
 const handleReject = (id) => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-white shadow-md rounded-md">
      <h2 className="text-2xl font-bold mb-6 text-green-600">Account Executive Review - (Employee Advance Settlement)</h2>
...
export default AEAdvanceSettlementApproalPage;