...
const dummyRequests = [
  {
    ...
    attachments: ['bill2.pdf', 'receipt1.jpg'],
    status: 'Pending',
    remarks: '',
    date: '2025-05-20',
...
const rowsPerPage = 2;
 ...
 const handleApprove = (id) => {
  ...
  setRequests(updated);
  setClarificationData(null); // close modal if any
};
    ...
    <div className="max-w-7xl mx-auto p-6">
            ...
            {paginatedRequests.map((req, index) => (
              <tr key={req.id} className="border">
                ...
                <td className="p-3 border">
                      ...
                      {/* Show Eye icon if rejected with clarification */}
      ...
      <ManagerClarificationModal
          ...
          onReject={(id) => {
            ...
            setClarificationData(null); // switch to remark modal
          }}
      />
