// src/pages/FoodRefreshmentLedgerPage.jsx
...
const FoodRefreshmentLedgerPage = () => {
  ...
  const loadLedgerData = () => {
    try {
      setLoading(true);
      const data = ExpenseLedgerService.getExpenseLedgerData('X1001003001');
      setLedgerData(data);
      setFilteredTransactions(data.transactions);
    } catch (error) {
      console.error('Error loading food refreshment ledger:', error);
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gray-100 p-5 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading food refreshment ledger...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-100 p-5 flex items-center justify-center">
        <div className="text-center text-red-600">
          <p>Failed to load food refreshment ledger data</p>
          <button 
...
export default FoodRefreshmentLedgerPage;