// src/pages/TravelExpenseLedgerPage.jsx
...
const TravelExpenseLedgerPage = () => {
  ...
  const loadLedgerData = () => {
    try {
      setLoading(true);
      const data = ExpenseLedgerService.getExpenseLedgerData('X1001002001');
      setLedgerData(data);
      setFilteredTransactions(data.transactions);
    } catch (error) {
      console.error('Error loading travel expense ledger:', error);
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gray-100 p-5 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading travel expense ledger...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-100 p-5 flex items-center justify-center">
        <div className="text-center text-red-600">
          <p>Failed to load travel expense ledger data</p>
          <button 
...
export default TravelExpenseLedgerPage;