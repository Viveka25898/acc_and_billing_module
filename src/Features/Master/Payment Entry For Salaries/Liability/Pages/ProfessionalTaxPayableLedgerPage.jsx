...
const ProfessionalTaxPayableLedgerPage = () => {
  ...
  const calculateSummary = useMemo(() => {
    return SalaryLedgerService.getLedgerSummary(filteredTransactions, 'L2002009')
  ...
  const handleExportToExcel = () => {
    SalaryLedgerService.exportLedgerToExcel('L2002009', filteredTransactions)
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Professional Tax Payable ledger...</p>
        </div>
      </div>
    )
  }
        ...
        {filteredTransactions.length > 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center border-t-4 border-green-600">
            ...
            <p className="text-gray-500 mb-4">
              No professional tax payable transactions match your current filters.
            </p>
            <button
              onClick={() =>
                setFilters({
