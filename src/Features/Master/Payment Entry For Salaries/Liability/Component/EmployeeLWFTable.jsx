  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="p-5 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h2 className="text-lg font-semibold text-purple-700">LWF Payable Ledger Entries</h2>
        <div className="flex gap-2">
          ...
          <button
            onClick={handlePrint}
            className="px-3 py-2 bg-purple-700 text-white text-sm rounded hover:bg-purple-600"
          >
            Print
          </button>
        </div>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-purple-700 text-white">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium uppercase">Receipt No.</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {ledgerData.map((row) => (
              <tr key={row.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 text-sm font-medium text-purple-600">{row.voucherNo}</td>
