...
const PFPayableHeader = ({ accountInfo }) => {
  return (
      ...
      <div className="p-6">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-green-800 mb-1">
              {accountInfo?.accountName || 'Employer PF Payable'}
            </h1>
            <p className="text-gray-600">Current Liability Account - EPFO Contribution</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-600">
            ...
            <div className="text-lg font-semibold text-green-700">
              {accountInfo?.glCode || accountInfo?.glAccountCode || 'L2002002'}
            </div>
          </div>
        ...
        <div className="mt-4 p-3 bg-green-50 border-l-4 border-green-500 rounded">
          <p className="text-sm text-gray-700">
            <span className="font-semibold text-green-700">ℹ️ Note:</span> Employer PF contribution
            is 12% of basic salary + DA, payable to EPFO by 15th of following month.
          </p>
        </div>
      </div>
    </div>
