...
const ProfessionalTaxFilter = ({ filters, filterOptions, onFilterChange }) => {
    ...
    <div className="bg-white rounded-lg shadow-lg border-l-4 border-green-600 mb-6">
      <div className="p-5 border-b border-green-200 flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Filter professional tax transactions</p>
        </div>
        <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="md:col-span-2 lg:col-span-3">
            ...
            <input
              ...
              placeholder="Search by voucher or challan number..."
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
            />
          </div>
        </div>
...
export default ProfessionalTaxFilter
