  ...
  return (
    <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg mb-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-800">PF Payable Filters</h3>
          <p className="text-sm text-gray-600">Filter PF liability transactions</p>
        </div>
        <div className="flex gap-2">
          ...
          <button
            onClick={() => onFilterChange('paymentStatus', 'Unpaid')}
