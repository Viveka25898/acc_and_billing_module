...
const LeaveProvisionFooter = ({ summaryData }) => {
  // Format currency
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        <div className="text-center text-sm text-gray-600">
          <p className="mb-1">GL Code: X2001001005 | Leave Provision Expense Ledger</p>
          <p className="text-xs text-gray-500">
            © {new Date().getFullYear()} iSmart Accounts & Billing Module • Leave provisions
            managed as per AS 15/Ind AS 19
          </p>
        </div>
      </div>
    </div>
