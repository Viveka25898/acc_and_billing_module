  ...
  return (
    <div className="bg-white p-4 md:p-6 rounded-xl shadow-lg mb-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-800">ESIC Contribution Filters</h3>
          <p className="text-sm text-gray-600">Filter ESIC transactions by various criteria</p>
        </div>
        <div className="flex gap-2">
          ...
          <button
            onClick={() => onFilterChange('paymentStatus', 'Late Paid')}
      ...
      >
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-gray-700 mb-2">TRRN / Challan No</label>
          <input
            type="text"
            placeholder="Search by TRRN or Challan..."
