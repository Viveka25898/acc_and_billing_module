// Manpower Services Revenue Ledger Page - R1001009
...
import {
  manpowerServicesRevenueData,
  getRevenueLedgerData,
  initializeManpowerServicesRevenueLedger,
} from '../data/manpowerServicesRevenueData'

const ManpowerServicesRevenueLedgerPage = () => {
  ...
  const loadLedgerData = async () => {
    try {
      ...
      // Initialize Manpower Services Revenue ledger if not exists
      initializeManpowerServicesRevenueLedger()
      ...
      const data = getRevenueLedgerData(accountCode || 'R1001009') || manpowerServicesRevenueData
...
export default ManpowerServicesRevenueLedgerPage
