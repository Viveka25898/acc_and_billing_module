// Rent on Machinery Revenue Ledger Page - R1001008
...
import {
  rentOnMachineryRevenueData,
  getRevenueLedgerData,
  initializeRentOnMachineryRevenueLedger,
} from '../data/rentOnMachineryRevenueData'

const RentOnMachineryRevenueLedgerPage = () => {
  ...
  const loadLedgerData = async () => {
    try {
      ...
      // Initialize Rent on Machinery Revenue ledger if not exists
      initializeRentOnMachineryRevenueLedger()
      ...
      const data = getRevenueLedgerData(accountCode || 'R1001008') || rentOnMachineryRevenueData
...
export default RentOnMachineryRevenueLedgerPage
