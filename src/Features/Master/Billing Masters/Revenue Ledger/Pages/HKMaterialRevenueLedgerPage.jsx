// HK Material Revenue Ledger Page - R1001005001
...
import {
  hkMaterialRevenueData,
  getRevenueLedgerData,
  initializeHKMaterialRevenueLedger,
} from '../data/hkMaterialRevenueData'

const HKMaterialRevenueLedgerPage = () => {
  ...
  const loadLedgerData = async () => {
    try {
      ...
      // Initialize HK Material Revenue ledger if not exists
      initializeHKMaterialRevenueLedger()
      ...
      const data = getRevenueLedgerData(accountCode || 'R1001005001') || hkMaterialRevenueData
...
export default HKMaterialRevenueLedgerPage
