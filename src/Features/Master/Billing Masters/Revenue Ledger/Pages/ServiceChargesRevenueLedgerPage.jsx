// Service Charges Revenue Ledger Page - R1001003
...
import {
  serviceChargesRevenueData,
  getRevenueLedgerData,
  initializeServiceChargesRevenueLedger,
} from '../data/serviceChargesRevenueData'

const ServiceChargesRevenueLedgerPage = () => {
  ...
  const loadLedgerData = async () => {
    try {
      ...
      // Initialize Service Charges Revenue ledger if not exists
      initializeServiceChargesRevenueLedger()
      ...
      const data = getRevenueLedgerData(accountCode || 'R1001003') || serviceChargesRevenueData
...
export default ServiceChargesRevenueLedgerPage
