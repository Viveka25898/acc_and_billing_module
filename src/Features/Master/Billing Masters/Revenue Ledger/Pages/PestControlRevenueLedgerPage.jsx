// Pest Control Charges Revenue Ledger Page - R1001010
...
import {
  pestControlRevenueData,
  getRevenueLedgerData,
  initializePestControlRevenueLedger,
} from '../data/pestControlRevenueData'

const PestControlRevenueLedgerPage = () => {
  ...
  const loadLedgerData = async () => {
    try {
      ...
      // Initialize Pest Control Revenue ledger if not exists
      initializePestControlRevenueLedger()
      ...
      const data = getRevenueLedgerData(accountCode || 'R1001010') || pestControlRevenueData
...
export default PestControlRevenueLedgerPage
