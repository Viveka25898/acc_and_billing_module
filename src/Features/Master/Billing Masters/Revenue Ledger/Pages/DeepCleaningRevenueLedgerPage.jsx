// Deep Cleaning Charges Revenue Ledger Page - R1001007
...
import {
  deepCleaningRevenueData,
  getRevenueLedgerData,
  initializeDeepCleaningRevenueLedger,
} from '../data/deepCleaningRevenueData'

const DeepCleaningRevenueLedgerPage = () => {
  ...
  const loadLedgerData = async () => {
    try {
      ...
      // Initialize Deep Cleaning Revenue ledger if not exists
      initializeDeepCleaningRevenueLedger()
      ...
      const data = getRevenueLedgerData(accountCode || 'R1001007') || deepCleaningRevenueData
...
export default DeepCleaningRevenueLedgerPage
